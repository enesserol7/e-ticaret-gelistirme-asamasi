...
class Job_application extends CI_Controller{
    ...
    public function __construct(){
        parent::__construct();
        $this->viewFolder = "job_application_v";
    ...
    public function index(){
        ...
        $items = $this->job_application_model->get_all(
            array()
        );
    ...
    public function view_form($id){
        $viewData = new stdClass();
        $item = $this->job_application_model->get(
            array(
                "id"    => $id,
            )
        );
    ...
    /*public function save(){
        ...
        if($validate){
            $insert = $this->job_application_model->add(
                array(
    ...
    public function update($id){
        ...
        $validate = $this->form_validation->run();
        if($validate){
            $update = $this->job_application_model->update(
                array(
                    "id"    => $id
                ),
                array(
    ...
    public function delete($id){
        $delete = $this->job_application_model->delete(
            array(
                "id"    => $id
            )
        );
    ...
    public function isActiveSetter($id){
        if($id){
            ...
            $this->job_application_model->update(
                array(
                    "id"    => $id
                ),
                array(
