	...
	public function save(){
        ...
        if($validate){
            if ($news_type == "image") {
                ...
                $image_345x136 = upload_picture($_FILES["img_url"]["tmp_name"], "uploads/$this->viewFolder",345,136, $file_name);
                $image_670x400 = upload_picture($_FILES["img_url"]["tmp_name"], "uploads/$this->viewFolder",670,400, $file_name);
                if($image_345x136 && $image_670x400){
                    $data = array(
