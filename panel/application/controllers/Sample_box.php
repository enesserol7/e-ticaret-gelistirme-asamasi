<?php
class Sample_box extends CI_Controller{
    public $viewFolder = "";
    public function __construct(){
        parent::__construct();
        $this->viewFolder = "sample_box_v";
        $this->load->model("sample_box_model");
        if(!get_active_user()){
    ...
    public function index(){
        ...
        $items = $this->sample_box_model->get_all(
            array()
        );
    ...
    public function view_form($id){
        $viewData = new stdClass();
        $item = $this->sample_box_model->get(
            array(
                "id"    => $id,
            )
        );
    ...
    public function delete($id){
        $delete = $this->sample_box_model->delete(
            array(
                "id"    => $id
            )
        );
