                	...
                	<?php foreach ($items as $item) { ?>
                		<tr id="ord-<?php echo $item->id; ?>">
                        	...
                        	<td class="text-center w450">
                                ...
                                <a href="<?php echo base_url("product/upload_form/$item->id"); ?>" class="btn btn-sm btn-purple btn-outline"><i class="fa fa-folder"></i> Dosyalar</a>
                                <a href="<?php echo base_url("product/price_list/$item->id"); ?>" class="btn btn-sm btn-pink btn-outline"><i class="fa fa-turkish-lira"></i> Fiyatlar</a>
                        	</td>
                    	</tr>
                	<?php } ?>                    
                </tbody>
