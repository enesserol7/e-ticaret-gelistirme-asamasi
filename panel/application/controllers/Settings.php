...
class Settings extends CI_Controller{
    ...
    public function save(){
        ...
        if($validate){
            ...
            $image_168x57 = upload_picture($_FILES["logo"]["tmp_name"], "uploads/$this->viewFolder",168,57, $file_name);
            $image_135x28 = upload_picture($_FILES["mobile_logo"]["tmp_name"], "uploads/$this->viewFolder",135,28, $file_name);
            $image_32x32  = upload_picture($_FILES["favicon"]["tmp_name"], "uploads/$this->viewFolder",32,32, $file_name);
            if($image_168x57 && $image_135x28 && $image_32x32){
